            ...
            <div className="w-full flex flex-col gap-4 justify-center">
              <div className='w-full flex justify-center'>
                <img
                  ...
                  className="rounded-lg w-52 bg-white"
                />
              </div>
              <div className='w-full flex justify-center'>
                <p className="bg-orange-600 rounded-lg w-96 py-2 flex justify-center items-center font-semibold text-2xl uppercase text-white">Construcciones en general</p>
              </div>
            </div>
            <div className="flex flex-col">
                <div className="flex mt-24 mb-12 flex-row justify-between">
                    <a href='/Dashboard#1' onClick={(e) => handleNavigation(e, '/Dashboard#1')} className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Inicio</a>
                    <a href='/Servicios#1' onClick={(e) => handleNavigation(e, '/Servicios#1')} className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Servicios</a>
                    <a href='/Nosotros#1' onClick={(e) => handleNavigation(e, '/Nosotros#1')} className="hidden md:block cursor-pointer text-gray-600 hover:text-white uppercase">Nosotros</a>
                ...
                <p className="w-full text-center my-12 text-gray-600">Copyright © 2024 Quilla Multiservicios S.A.C</p>
            </div>
        </div>
    </div>
  )
